...
export interface ChatControllerGetChatsParams {
  userId: string;
}

export type ChatControllerGetChatsData = GetChatsResponse;
 ...
 */
export class ChatServiceClient<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  chat = {
    /**
     * No description
     *
     ...
     * @request GET:/chat/get-chat-list
     */
    chatControllerGetChats: (query: ChatControllerGetChatsParams, params: RequestParams = {}) =>
      this.request<ChatControllerGetChatsData, any>({
        path: `/chat/get-chat-list`,
        method: "GET",
        query: query,
        format: "json",
        ...params,
